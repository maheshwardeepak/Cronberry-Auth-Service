...
public class CronberryExceptionHandler {
	...
	@ExceptionHandler(CronberryException.class)
	public ResponseEntity<Map<String,Object>> cronberryExceptionHandler(CronberryException ex ){
		Map<String, Object> map=new HashMap<>();
		map.put(UIConstants.STATUS, UIConstants.FALSE);
		map.put(UIConstants.ERROR_MSG, ex.getMessage());
